...
A simple Proof of Concept (POC) for an authentication system built using plain HTML only. just basic HTML structure with anchor tag navigation to demonstrate a typical authentication flow.
